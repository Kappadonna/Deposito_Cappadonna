...
while on:
    ...
    match risposta:
        case 'log-in': # in caso di login
            ...
            dati = accounts[id-1][3]               # assegna nome dati alla lista vuota presente nel profilo dell'utente
            risultati = accounts[id-1][4]          # assegna nome risultati alla lista vuota presente nel profilo dell'utente
